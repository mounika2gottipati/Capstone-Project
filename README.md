...
3.SmartWay Vehicles and Environmental Impact:

Fuel Economy: The box plot comparing SmartWay vs. Non-SmartWay vehicles clearly shows that SmartWay vehicles have a significantly higher median combined MPG. The interquartile range (IQR) for SmartWay vehicles is generally higher and less spread out towards lower MPGs compared to non-SmartWay vehicles.
...
4.Feature Relationships (from Scatter Plots and Heatmap):

Engine Displacement vs. MPG: The scatter plot visually confirms a clear negative correlation: as engine displacement (L) increases (e.g., from 1.0L to 8.0L), the combined MPG generally decreases.
